...
<div class="page-content">
	...
	<?php elseif (is_search()) : ?>
        ...
        <?php elseif (is_page_template( 'page-templates/page-list-children.php' ) ) : ?>
        
            <p><?php _e( 'Looks like you need to add some Child Pages! Simply create some new Pages and make this Page their "Parent Page."', 'proto' ); ?>
            </p>
